...
Les jeux les plus influents sont **Yie Ar Kung Fu** qui pose les fondations ; **Street Fighter II** et ses combos qui rendent le jeu technique ; **Battle Arena Toshiden** et ses pas latéraux qui font entrer le style dans la 3D, même si c'est plutôt **Tekken** qui le popularisera ; et **Super Smash Bros** et ses combats à 4 en simultané et son orientation "tout public".
...
:star: **Yie Ar Kung Fu** (1985, Konami) est le premier à demander d'affronter **plusieurs adversaires** avec des **styles différents**, plutôt qu'une simple succession d'adversaires de plus en plus difficiles. C'est également le premier à utiliser une **barre de vie**, des **sauts** importants, des **coups variés** en fonction des boutons pressés, et à marquer l'**impact des coups** avec une petite pause dans l'animation : c'est un **jeu fondateur** du genre.

**Galactic Warriors** (1985, Konami) sort un peu après Yie Ar Kung Fu, et c'est le premier à proposer **plusieurs  personnages jouables**, et également le premier à permettre de **bloquer** les coups adverses. Il est cependant moins bien réalisé que son aîné, et beaucoup moins séduisant.
...
:star: **Street Fighter** (1987, Capcom) en plus d'intégrer toutes les mécaniques désormais standard, c'est le premier à avoir des **boules de feu** comme dans Dragon Ball. C'est aussi le jeu qui popularisera les **contrôles à 6 boutons**, le premier qui permet le **blocage juste en reculant** (les précédents avaient des systèmes de blocage plus complexes), et le premier qui **permet à un second joueur de s'imposer** en tant qu'adversaire au milieu d'une partie. C'est, avec Yie Ar Kung Fu, une **référence de la période** pré-Street Fighter 2.
